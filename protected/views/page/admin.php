...
$this->menu = array(
	...
	array('icon' => 'list-alt white', 'label' => Yii::t('page', 'Управление'), 'url' => array('/page/admin')),
...
");
?>
<?php echo CHtml::link(Yii::t('page', '<i class="icon-search"></i> Поиск страниц <span class="caret"></span>'),'#',array('class' => 'search-button btn btn-small'))?>
