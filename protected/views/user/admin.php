...
");
?>
<?php echo CHtml::link(Yii::t('user', '<i class="icon-search"></i> Поиск пользователей <span class="caret"></span>'),'#',array('class' => 'search-button btn btn-small'))?>
		...
		*/
		...
		array(
			...
			'buttons'  => array(
				'password' => array(
					'label' => false,
					'url' => 'array("/user/changepassword/", "id"=>$data->id)',
