...
$this->menu = array(
	...
	array('icon' => 'list-alt white','label' => Yii::t('news', 'Управление'), 	'url' =>array('news/admin')),
...
<?php
	...
	'columns'		=> array(
		...
		array(
			'name'  => 'slug',
			'type' => 'raw',
			'value' => 'CHtml::link($data->slug, array("news/show/$data->slug"))',
		),
		'creation_date',
		'change_date',
		array(
		...
		array(
			...
			'filter' => array('' => Yii::t('menu', 'Все'), 1 => Yii::t('menu', 'Опубликовано'), 0 => Yii::t('menu', 'Черновики'), 2 => Yii::t('menu', 'На модерации')),
			'htmlOptions' => array('style'=>'width:40px; text-align:center;'),
		),
		/*'creation_date',
		'change_date',
