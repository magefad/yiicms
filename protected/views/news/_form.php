...
<p class="alert alert-info"><?php echo Yii::t('news', 'Поля, отмеченные <span class="required">*</span> обязательны для заполнения.')?></p>
	...
	<?php
		$this->widget('ext.tinymce.TinyMce', array(
			'model' => $model, 'attribute' => 'body_cut',
			'settings' => array(
				'height' => '25px',
				...
				'content_css' => Yii::app()->assetManager->getPublishedUrl(Yii::getPathOfAlias('ext.bootstrap.assets')).'/css/bootstrap.min.css, /css/main.css'
			)
		));
	?>
	...
	<?php $this->widget('ext.tinymce.TinyMce', array('model' => $model, 'attribute' => 'body', 'settings' => array('content_css' => Yii::app()->assetManager->getPublishedUrl(Yii::getPathOfAlias('ext.bootstrap.assets')).'/css/bootstrap.min.css'))); ?>
