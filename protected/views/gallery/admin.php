...
$this->menu = array(
	...
	array('icon' => 'list-alt white', 'label' => Yii::t('page', 'Управление'), 'url' => array('/gallery/admin')),
	array('icon' => 'file', 'label' => Yii::t('page', 'Добавить'), 'url' => array('create')),

	array('label' => Yii::t('page', 'Фотографии')),
	#array('icon' => 'list-alt', 'label' => Yii::t('page', 'Управление'), 'url' => array('/galleryPhoto/manager')),
);
...
");
?>
<?php echo CHtml::link(Yii::t('gallery', '<i class="icon-search"></i> Поиск <span class="caret"></span>'),'#',array('class' => 'search-button btn btn-small'))?>
...
<?php $this->widget('CustomTbGridView', array(
	...
	'columns'		=> array(
		...
		array(
			'name'  => 'slug',
			'type' => 'raw',
			'value' => 'CHtml::link($data->slug, array("gallery/show/$data->slug"))',
		),
		array(
			'name'  => 'sort',
			'type'  => 'raw',
		...
		array(
			...
			'buttons'  => array(
				'manager' => array(
					'label' => false,
					'url' => 'array("/galleryPhoto/manager", "id"=>$data->id)',
