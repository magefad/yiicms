...
<p class="alert alert-info"><?php echo Yii::t('gallery', 'Поля, отмеченные <span class="required">*</span> обязательны для заполнения.')?></p>
	...
	<?php echo $form->textFieldRow($model,'slug', array('class'=>'span5', 'maxlength' => 150, 'placeholder' => 'Только латинские буквы и знак подчеркивания')); ?>
