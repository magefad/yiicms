      ...
      if(node.hasClass("parent")) {
        ...
        childNodes.each(function() {
          $(this).children("td")[options.treeColumn].style.paddingLeft = padding + "px";
            var beforeTreeColumn;
			if (beforeTreeColumn = $("#before-"+$(this).attr("id")).children("td")[options.treeColumn]) {
                beforeTreeColumn = padding + "px";
			}
			$("#after-"+$(this).attr("id")).children("td")[options.treeColumn].style.paddingLeft = padding + "px";
		});
