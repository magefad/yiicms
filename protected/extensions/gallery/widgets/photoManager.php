...
class photoManager extends Widget
{
	...
	public $controllerRoute = '/galleryPhoto';
	public $assets;
	...
	public function run()
	{
		...
		$this->render('photoManager', array(
			...
			'slug' => $this->slug,
			'albums' => $this->albums,
			'galleryPhotos' => $model->findAll(array('condition' => 'gallery_id=:gallery_id', 'order' => 'sort', 'params' => array(':gallery_id' => $this->galleryId)))
		));
	}
}
