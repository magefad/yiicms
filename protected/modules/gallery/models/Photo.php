...
class Photo extends CActiveRecord
{
    ...
    public function attributeLabels()
    {
        return array(
            ...
            #'rank' => 'Rank',
            'file_name'           => Yii::t('GalleryModule.gallery', 'File'),
            'create_time'         => Yii::t('GalleryModule.gallery', 'Created'),
            'create_user_id'      => Yii::t('GalleryModule.gallery', 'Author'),
            'update_user_id'      => Yii::t('GalleryModule.gallery', 'Update User'),
            'alt'                 => 'Alt',
            'type'                => Yii::t('GalleryModule.gallery', 'Type'),
            'status'              => Yii::t('GalleryModule.gallery', 'Status'),
            'sort_order'          => Yii::t('GalleryModule.gallery', 'Order'),
            'author_search'       => Yii::t('GalleryModule.gallery', 'Author'),
            'changeAuthor_search' => Yii::t('GalleryModule.gallery', 'Update User'),
            'gallery_search'      => Yii::t('GalleryModule.gallery', 'Album'),
        );
    }
