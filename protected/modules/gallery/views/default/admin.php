...
$this->menu = array(
	...
	array('icon' => 'list-alt white', 'label' => Yii::t('page', 'Управление'), 'url' => array('/gallery/default/admin')),
...
<?php $this->widget('CustomTbGridView', array(
	...
	'columns'               => array(
		...
		array(
			'name' => 'name', 'type' => 'raw', 'value' => 'CHtml::link($data->name,array("update", "id" => $data->id))'
		),
		#'description',
		#'keywords',
		array(
