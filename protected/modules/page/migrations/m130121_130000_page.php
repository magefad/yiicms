...
class m130121_130000_page extends EDbMigration
{
    public function safeUp()
    {
        ...
        $this->insert('{{page}}', array(
                ...
                'content'        => '<h1>Главная страница</h1><p>Начальная страница. Зайдите в управление страницами, чтобы изменить текст.</p>',
                'slug'           => 'index',
                'sort_order'     => 1,
                'create_user_id' => 1,
