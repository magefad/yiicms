...
class DefaultController extends Controller
{
	...
	public function actionUpdate($id)
	{
		...
		if ( isset($_POST['Page']) )
		{
			...
			{
				$model->updateCounters(array('menu_order' => -1), 'menu_order<=:menu_order AND menu_order>=:current_menu_order', array('menu_order' => $model->attributes['menu_order'], 'current_menu_order' => $currentMenuOrder));
			}
			if ( $model->attributes['menu_order'] < $currentMenuOrder )
			{
				$model->updateCounters(array('menu_order' => +1), 'menu_order>=:menu_order AND menu_order<=:current_menu_order', array('menu_order' => $model->attributes['menu_order'], 'current_menu_order' => $currentMenuOrder));
