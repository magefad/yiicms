...
$this->breadcrumbs = array(
    Yii::t('BlogModule.blog', 'Blogs') => array('/blog/list'),
...
<div class="post">
    ...
    <i class="icon-user"></i> <?php echo $model->createUser->username; ?> | <i class="icon-calendar"></i> <?php echo $model->publish_time; ?> | <i class="icon-tags"></i> <?php echo Yii::t('BlogModule.blog', 'Tags'); ?>:
